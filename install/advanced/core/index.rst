...
.. code-block:: shell
  ...
  sudo apt install -y libxslt1-dev libjpeg-dev libpng-dev libpq-dev libgdal-dev libgdal26
...
.. code-block:: shell
  ...
  sudo wget http://www-us.apache.org/dist/tomcat/tomcat-8/v8.5.55/bin/apache-tomcat-8.5.55.tar.gz
  sudo tar xzf apache-tomcat-8.5.55.tar.gz
  sudo mv apache-tomcat-8.5.55 /usr/local/apache-tomcat8
